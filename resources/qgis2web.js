...
map.getView().fit([8513519.888327, 998179.653844, 8530462.370383, 1004651.814525], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Thekkumbhagom_Administrative_Boundary</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (80 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Thekkumbhagom Panchayath is situated in Karunagappally Taluk of Kollam District.';
            }
